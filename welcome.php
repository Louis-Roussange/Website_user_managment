                            ...
                            <div class="col-xl-5 col-md-6" >
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="statistics.php">View Statistics</a>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="small text-white stretched-link" href="inventory.php">View Inventory</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
...
<?php 
//$query=mysqli_query($con,"select * from user where idu in (select id2 from users NATURAL JOIN friends where idu ='$userid')");
